...
public class Asia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.loroalcoiris);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.faisandorado);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.himalayan);
    }
