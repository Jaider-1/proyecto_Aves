...
public class Africa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer1 = MediaPlayer.create(this, R.raw.paraisowilson);
        mediaPlayer2 = MediaPlayer.create(this, R.raw.grullacoronada);
        mediaPlayer3 = MediaPlayer.create(this, R.raw.mayorparaiso);
    }
    ...
    public void onclick(View view) {
        ...
        if (view.getId() == imageButton3) {
            _volver = new Intent(Africa.this, MainActivity.class);
